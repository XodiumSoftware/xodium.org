            ...
            <section id="landing" class="relative isolate px-6 pt-14 lg:px-8 pb-24 sm:pb-32">
                ...
                <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    <div class="text-center">
                        <h1 class="text-4xl font-bold tracking-tight text-base-content sm:text-6xl whitespace-nowrap">
                            "CODING "
                        ...
                        <div class="mt-10 flex items-center justify-center gap-x-6">
                            ...
                            <a href="https://wiki.xodium.org" class="btn btn-outline btn-outline-ghost btn-hover-warning btn-lift">
                                "Read Docs"
                            </a>
                        </div>
                    </div>
