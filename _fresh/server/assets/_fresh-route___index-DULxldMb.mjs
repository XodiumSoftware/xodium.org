import {a, b as Typewriter, d as define, H as Header, P as ProjectGrid, s, T as TeamGrid, u} from "../server-entry.mjs";
import "node:process";
...
function Footer() {
    ...
    return a($$_tpl_1$2, s(currentYear), u("a", {
        href: homePage,
        class: "link link-hover link-primary",
        children: "XODIUM™"
    }), s(footerLinks.map((link) => u("a", {
        href: link.href,
        class: "link link-hover link-primary",
...
const index = define.page(() => a($$_tpl_1, u(Header, null), u(Grid, null), u(Typewriter, {
    ...
    children: a($$_tpl_2)
}), u(ProjectGrid, null), u(TeamGrid, null), u(Footer, null)));
const routeCss = null;
const css = routeCss;
const config = void 0;
